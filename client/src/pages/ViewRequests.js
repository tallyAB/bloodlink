...
export default function ViewRequests() {
  ...
  const requestFormSubmit = () => {
    ...
    axios
      .post("https://bloodhub-client.herokuapp.com/ViewRequests", manhoos)
      .then((response) => {
  ...
  const AccceptRequest = (e) => {
    ...
    axios
      .post("https://bloodhub-client.herokuapp.com/AcceptRequest", details)
      .then((response) => {
        alert(response.data);
        requestFormSubmit();
      });
  ...
  const RejectRequest = (e) => {
    ...
    axios
      .post("https://bloodhub-client.herokuapp.com/RejectRequest", details)
      .then((response) => {
        alert(response.data);
        requestFormSubmit();
      });

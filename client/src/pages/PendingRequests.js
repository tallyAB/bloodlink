...
export default function PendingRequests() {
  ...
  const requestFormSubmit = () => {
    ...
    axios
      .post("https://bloodhub-client.herokuapp.com/PendingRequests", manhoos)
      .then((response) => {
        set_brl(response.data);
      });
  };

  const UnsendRequest = (e) => {
    ...
    axios
      .post("https://bloodhub-client.herokuapp.com/UnsendRequest", details)
      .then((response) => {
        alert(response.data);
        requestFormSubmit();
      });
  ...
  return (
    <div>
      ...
      <div>
        View Pending page, current user: {user_data["First_Name"]} with cnic:{" "}
        {user_data["CNIC"]}
      </div>
